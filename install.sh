...
echo -e "   ${YELLOW}(Укажите при первом входе!)${NC}"
echo ""
echo -e "${BLUE}2. Portainer:${NC}"
echo "   (Задайте пароль при первом открытии ссылки)"
echo ""
echo -e "${BLUE}3. Postgres (Внутренняя БД для n8n):${NC}"
echo "   User: n8n"
...
echo "• Канал: https://t.me/not_with_a_knife"
echo ""
echo -e "${YELLOW}💡 Совет: Чтобы команды docker работали без sudo в этой сессии, введите:${NC}"
echo "newgrp docker"
